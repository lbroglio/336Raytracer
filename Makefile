...
raytrace336.o: raytrace336.cpp
	g++ -Wall -Werror -ggdb -c raytrace336.cpp -o bin/raytrace336.o

vectors.o: world/vectors.cpp world/vectors.hpp
	g++ -Wall -Werror -ggdb -c  world/vectors.cpp -o bin/vectors.o

worldObjects.o: world/worldObjects.cpp world/worldObjects.hpp
	g++ -Wall -Werror -ggdb -c  world/worldObjects.cpp -o bin/worldObjects.o

modelReaders.o: file-io/modelReaders.cpp file-io/modelReaders.hpp
